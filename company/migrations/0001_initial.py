# Generated by Django 4.2 on 2023-08-16 13:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ceo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='companies', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='company',
            name='logo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.s3attachment'),
        ),
    ]
